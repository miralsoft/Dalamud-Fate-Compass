...
public sealed class ReleaseNotesTests
{
    ...
    public void NewestNotesMatchTheAssemblyVersion()
    {
        ...
        Assert.True(
            ...
            + "Add a section for it in src/FateHelper.Core/News/Notes/*.json.");
    }
    ...
    public void NotesAreEmbeddedUnderTheExpectedNames()
    {
        ...
        Assert.Contains("FateHelper.Core.News.Notes.en.json", resources);
        Assert.Contains("FateHelper.Core.News.Notes.de.json", resources);
    }
}
