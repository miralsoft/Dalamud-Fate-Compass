...
using FateHelper.Core.Announce;
...
internal sealed class ConfigWindow : Window, IDisposable
{
    ...
    internal ConfigWindow(
        ...
        : base("FateHelper###FateHelperConfig")
    {
    ...
    public override void PreDraw() => WindowName = $"{localizer.Get(StringKeys.WindowConfigTitle)}###FateHelperConfig";
    ...
    public override void Draw()
    {
        ...
        try
        {
            if (!ImGui.BeginTabBar("##fateHelperSettings"))
            {
                return;
            }
