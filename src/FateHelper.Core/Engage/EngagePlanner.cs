...
public static class EngagePlanner
{
    ...
    /// </summary>
    public static EngagePlan PlanRemount(PlayerSnapshot player, FateHelperSettings settings)
    {
        ArgumentNullException.ThrowIfNull(player);
        ArgumentNullException.ThrowIfNull(settings);
    ...
    private static bool AllStepsDisabled(FateHelperSettings settings) =>
